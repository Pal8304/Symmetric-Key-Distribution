...
class Message:
    ...
    def decrypt_message(self , encrypted_message):
        ...
        iv = byte_encrypted_message[:16]  # Extract IV from the start of the encrypted message
        cipher = AES.new(self.symmetric_byte_key, AES.MODE_CBC, iv)
        decrypted_message = unpad(cipher.decrypt(byte_encrypted_message[16:]), AES.block_size)
